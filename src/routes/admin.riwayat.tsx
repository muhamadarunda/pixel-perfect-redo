...
function KelolaRiwayat() {
  return (
    <div>
      ...
      <p className="mt-5 text-slate-600">Menampilkan catatan log keseluruhan. (Fitur sama dengan Menu Riwayat, + fungsi hapus)</p>

      <div className="mt-5 overflow-hidden rounded-2xl border border-white/60 bg-gradient-to-br from-violet-200/60 via-purple-300/40 to-purple-400/40 backdrop-blur-2xl">
